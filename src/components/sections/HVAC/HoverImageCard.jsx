	...
	const services = [
		{
			...
			totalProject: 120,
			img: "https://skepper.in/000_Skepper_test/real/phe/hvac_card1.jpg",
			svg: "",
		},
		{
			id: 2,
			...
			iconName: "tji-optimization",
			totalProject: 85,
			img: "https://skepper.in/000_Skepper_test/real/phe/hvac_card2.jpg",
			svg: "",
		},
		{
			id: 3,
			...
			iconName: "tji-optimization",
			totalProject: 64,
			img: "https://skepper.in/000_Skepper_test/real/phe/hvac_card3.jpg",
			svg: "",
		},
		{
			id: 4,
			...
			iconName: "tji-optimization",
			totalProject: 40,
			img: "https://skepper.in/000_Skepper_test/real/phe/hvac_card4.jpg",
			svg: "",
		},
	].slice(0, 4);
