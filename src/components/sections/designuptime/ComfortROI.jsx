...
export default function ComfortROI() {
      ...
      const leftBg =
    "https://skepper.in/000_Skepper_test/real/designuptime/left-card.jpg"; // vent/ceiling style
  const img1 =
    "https://skepper.in/000_Skepper_test/real/designuptime/iaq.jpg"; // think clearer
  const img2 =
    "https://skepper.in/000_Skepper_test/real/designuptime/slider3.jpg"; // stay balanced
  const img3 =
    "https://skepper.in/000_Skepper_test/real/designuptime/lighting.jpg"; // feel better
 const img4 =
    "https://skepper.in/000_Skepper_test/real/designuptime/energy.jpg"; // feel better
  ...
  return (
    <section className="phases-section  roi_sec">
      ...
      <div className="phases-hero">
        <img
          src="https://skepper.in/000_Skepper_test/real/roi.jpg"
...
<div className="full_img_sec">
  <div className="static-images-flex">
    ...
    <div className="static-img-box wide-box">
      <img 
        src="https://skepper.in/000_Skepper_test/real/full1.jpg" 
    ...
    <div className="static-img-box standard-box">
      <img 
        src="https://skepper.in/000_Skepper_test/real/full2.jpg" 
