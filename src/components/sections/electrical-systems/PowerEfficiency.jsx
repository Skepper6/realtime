        ...
        <div className="design__grid">
          ...
          <div className="design__col design__col--left">
            <div className="design__imgCard">
              <img className="design__img" src="https://skepper.in/000_Skepper_test/real/electrical/power-left.jpg" alt="electrical space" />
            </div>
          ...
          <div className="design__col design__col--right">
            <div className="design__imgCard design__imgCard--tall">
              <img className="design__img" src="https://skepper.in/000_Skepper_test/real/electrical/power-right.jpg" alt="Building exterior" />
            </div>
          </div>
        </div>
      </div>
