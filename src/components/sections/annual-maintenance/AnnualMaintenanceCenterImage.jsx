...
const AnnualMaintenanceCenterImage = () => {
    return (
                                ...
                                <div className="desc  wow fadeInUp" data-wow-delay="0.3s">
                                    <p className="text-white">
                                     The most sustainable power systems don’t rely on fixes later; they’re designed right from the start.
                                      ...
                                      <p className="text-white">
                                    At Realtime, energy efficiency is embedded into every layer of our AnnualMaintenance infrastructure, from transformer sizing and load distribution to smart controls and future-ready integrations.
                                    </p>
                                </div>
...
export default AnnualMaintenanceCenterImage;
