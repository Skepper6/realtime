                ...
                <div className="top_bar">
                    <div className={`rt-hero__frame ${draw ? "is-draw" : ""}`} aria-hidden="true" style={{ zIndex: 2 }}>
                        ...
                        <div className="sanim_img">
                            <img className="rt-floatIcon rt-floatIcon--down" src="https://skepper.in/000_Skepper_test/real/phe/phe_white.png" alt="" />
                            <img className="rt-floatIcon rt-floatIcon--up" src="https://skepper.in/000_Skepper_test/real/phe/phe_green.png" alt="" />
                        </div>
                    </div>
