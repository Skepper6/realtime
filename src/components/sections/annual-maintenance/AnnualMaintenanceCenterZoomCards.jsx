...
const AnnualMaintenanceCenterZoomCards = () => {
  ...
  const images = {
    left: "https://theskepper.com/000_Skepper_test/real/annual_leftcard.jpg",
    center: "https://theskepper.com/000_Skepper_test/real/annual_centercard.jpg",
    right: "https://theskepper.com/000_Skepper_test/real/annual_rightcard.jpg",
  };
          ...
          <article className="szc-card szc-center" ref={centerRef}>
            ...
            <div className={`szc-overlay ${vars.q > 0.15 ? "is-active" : ""}`}>
              <div className="szc-overlayInner">
                ...
                {/* <button
                  className="szc-btn szc-step szc-step3"
                  type="button"
...
export default AnnualMaintenanceCenterZoomCards;
