...
const AnnualMaintenanceHoverCardImage = () => {
	...
	return (
		<section className="h10-service-section AnnualMaintenance_card section-space hover_img_card" ref={animContainerRef}>
...
export default AnnualMaintenanceHoverCardImage;
